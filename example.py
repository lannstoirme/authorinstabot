...
bot = InstaBot(
    ...
    ["I really love the content you are posting on your IG"],
    ["Your IG is so inspirational"],
    ["Wow, you have done such an incredible job on your account"],
    ["You are so talented, love your content"],
    ["I am feeling really inspired by this"],
    ["Thanks for sharing this, I love it so much"],
